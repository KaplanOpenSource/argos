export const deleteExperiment = (state, setState, name) => {
    setState(draft => {
...
export const addExperiment = (state, setState, newExp = undefined) => {
    setState(draft => {
...
export const setExperiment = (state, setState, name, data) => {
...
export const undoOperation = (state, setState) => {
    setState(draft => {
...
export const redoOperation = (state, setState) => {
    setState(draft => {
